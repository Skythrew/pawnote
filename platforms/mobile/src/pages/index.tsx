...
const Page: Component = () => {
  ...
  const [availableSessions] = createSignal<AvailableSession[] | null>([]);
        ...
        >
          {sessions => (
            <>
              ...
              >
                {session => (
                  <A class="w-full" href={`/session/${session.slug}`}>
                    <div
              ...
              <A href="/link" class="text-center text-latte-text text-opacity-50 underline underline-latte-text/50 underline-offset-4 underline-dotted hover:border-solid hover:underline-solid">
