  ...
  return (
    <div class="relative w-full">
      <input
        ...
        class="peer block w-full appearance-none border-2 border-gray-300 rounded-lg bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-latteText autofill-bg-rose focus:outline-none focus:ring-0"
        classList={{
      ...
      />
      <label for={id}
        class="text-latte-subtext0 pointer-events-none absolute left-2 top-2 z-[1] origin-[0] scale-75 transform rounded-md bg-latte-base px-2 text-sm duration-150 peer-focus:top-2 peer-placeholder-shown:top-1/2 -translate-y-4 peer-focus:scale-75 peer-placeholder-shown:scale-100 peer-focus:px-2 peer-focus:text-latteBase peer-focus:-translate-y-4 peer-placeholder-shown:-translate-y-1/2"
        classList={{
